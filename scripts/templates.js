...
output += runtime.suppressValue(t_4, env.opts.autoescape);
output += "\" value=\"";
output += runtime.suppressValue((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "players")),t_4)?runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "players")),t_4):"Игрок " + (t_4 + 1)), env.opts.autoescape);
output += "\" />\n</div>\n";
;
}
}
...
output += " карт)</span>\n</header>\n</template>\n<form id=\"round-form\" class=\"vertical-stack full-width\">\n  <table>\n    <thead>\n      <tr>\n        <th>Игрок</th>\n        <th>Ставка</th>\n        <th>Взятки</th>\n        <th>Бонусы</th>\n        <th>Счет</th>\n      </tr>\n    </thead>\n    <tbody>\n      ";
var t_9;
...
output += " ";
output += runtime.suppressValue((lineno = 50, colno = 29, runtime.callWrap(macro_t_7, "playerRow", context, [runtime.contextOrFrameLookup(context, frame, "gameData"),t_13])), env.opts.autoescape);
output += " ";
;
}
}
